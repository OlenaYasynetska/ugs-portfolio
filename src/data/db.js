export const news = [
  ...
  },
  {
    ...
    title: {
      ...
      ua: '03.07.2025 Починаючи з наступного понеділка, влада міста Штайр змінить розклад автобусних перевезень відповідно до літнього розкладу на період канікул.'
    },
    text: {
